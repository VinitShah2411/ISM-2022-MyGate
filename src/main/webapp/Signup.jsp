    ...
    <div class="main-agileinfo">
      <div class="agileits-top">
        <form action="SignupController" method="post">
          <input class="text w3lpass" type="text" name="firstName" placeholder="FirstName" required=""> 
          <input class="text" type="text" name="lastName" placeholder="LaststName" required="">
		...
		<label class="radio-inline mr-3"><input type="radio" name="gender" value="female"> Female</label>
          ...
          <input class="text w3lpass" type="text" name="contact_no" placeholder="Contact" required="">
